    ...
    public static void build(Campaign c) {
        ...
        c.add(new Mission(c.missionId(4), "Notes Java Ignores", 1)
            ...
            .recap(
                ...
                + "    /* ... */     ignores everything between, over any number\n"
                + "                  of lines, and is how you switch code off\n"
                + "\n"
        ...
        c.add(new Mission(c.missionId(6), "Staying on the Line", 2)
            ...
            .concept("print and println",
                ...
                + "\n"
                + "    System.out.println(\"text\")    prints, then moves to a new line\n"
                + "    System.out.print(\"text\")      prints, and stays where it is\n"
                + "\n"
        ...
        c.add(new Mission(c.missionId(10), "INIT COMPLETE", 4)
            ...
            .recap(
                ...
                + "You can now:\n"
                + "\n"
                + "    - explain what javac and the JVM do, and why a JRE is not\n"
                + "      enough\n"
